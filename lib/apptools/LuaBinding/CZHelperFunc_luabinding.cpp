...
** Generated automatically by tolua++-1.0.92 on Fri Nov  8 15:47:57 2013.
*/
...
{
 tolua_usertype(tolua_S,"CZHelperFunc");
 
}

/* method: adler32 of class  CZHelperFunc */
#ifndef TOLUA_DISABLE_tolua_CZHelperFunc_luabinding_CZHelperFunc_adler3200
static int tolua_CZHelperFunc_luabinding_CZHelperFunc_adler3200(lua_State* tolua_S)
{
...
#endif
 {
  ...
  {
   unsigned int tolua_ret = (unsigned int)  CZHelperFunc::adler32(data,len);
...
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'adler32'.",&tolua_err);
 return 0;
#endif
}
...
TOLUA_API int tolua_CZHelperFunc_luabinding_open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,NULL);
  ...
  tolua_beginmodule(tolua_S,"CZHelperFunc");
   tolua_function(tolua_S,"adler32",tolua_CZHelperFunc_luabinding_CZHelperFunc_adler3200);
